                ...
                <motion.div className="grid h-auto w-full grid-cols-1 gap-10 md:grid-cols-3 md:gap-y-12 lg:grid-cols-5">
                    {data?.data.map((item: any, index: number) => (
                        <motion.div key={index} variants={itemVariants}>
                            <div className="group relative z-10 h-[350px] w-auto cursor-pointer overflow-hidden rounded-[6px] transition-all duration-700 ease-in-out md:h-[230px] md:hover:z-10">
