...
export default function EnhancedDirectorProfile({ data }: any) {
    ...
    return (
        <main
            ...
            } relative flex min-h-screen w-full flex-col items-center gap-8 overflow-hidden px-4 py-10 text-white md:px-20 md:py-16`}
        >
                    ...
                    <div className="mb-6 flex flex-col items-center justify-between gap-4 md:flex-row">
                        <div className="text-center md:text-left">
                            <h2 className="text-2xl font-bold md:text-3xl">
                                {data[0].attributes?.name} {data[0].attributes?.lastname}
                            </h2>
