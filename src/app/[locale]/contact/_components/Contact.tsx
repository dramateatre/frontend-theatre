...
export default function Contact() {
    ...
    return (
        <section className="h-auto w-full px-5 md:px-7 lg:px-40 xl:px-64">
            <div className="relative h-full w-full rounded-lg bg-[#1D1B26] shadow-md">
                ...
                >
                    <div className="mb-6 grid h-auto w-full grid-cols-1 gap-6 md:grid-cols-2 text-white">
