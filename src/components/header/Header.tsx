...
export default function Header() {
    ...
    return (
        <div
            className={` ${locale === 'en' ? 'text-lg' : 'text-base'} relative z-50 flex h-24 w-full flex-row items-center justify-end gap-6 border-b border-white bg-[#0f1017] px-6 backdrop-blur-none md:px-7 lg:px-20`}
        >
            <Link href="/">
